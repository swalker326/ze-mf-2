...
exports.removeAppHashCache = exports.getAppHashCache = exports.setAppHashCache = void 0;
...
async function setAppHashCache(application_uid, value) {
    await storage;
    void (await (0, node_persist_1.setItem)(`${storage_keys_1.StorageKeys.ze_hash_cache}:${application_uid}`, value, {
        ttl: 1000 * 60 * 60 * 24,
    }));
}
